...
{
	Message(11, "\nОберіть операцію");
	if (numberofnotes>4) cout << "\n1 - Вивести усі акорди в порядку обернень" <<
		"\n2 - Вивести лише нонакорди з ноною у мелодичному положенні" <<
		"\n3 - вивести лише акорди з інтервалом ундецими між крайніми голосами" <<
		"\n4 - Вивести усі акорди в порядку зростання діапазону" <<
		"\n5 - Вивести нонакорди та обернення від заданої ноти" <<
		"\n6 - Вивести нонакорди та обернення із заданим мелодичним тоном" << endl;
	else  cout << "\n1- Вивести усі акорди в порядку обернень" <<
		"\n2 - Вивести усі акорди в порядку зростання діапазону" <<
		"\n3 - Вивести усі акорди та обернення від заданої ноти" <<
		"\n4 - Вивести нонакорди та обернення із заданим мелодичним тоном" << endl;
